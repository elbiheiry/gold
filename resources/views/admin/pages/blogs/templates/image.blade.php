<div class="modal-dialog" role="document">
    <div class="modal-content text-center">
        ...
        <form class="edit-form" action="{{route('admin.blogs.image.edit',['id' => $blog->id , 'key' => $key])}}" method="post" enctype="multipart/form-data">
            <div class="modal-body">
                ...
                <div class="col-md-12 form-group ">
                    ...
                    <img src="{{asset('storage/uploads/blogs/'.$images[$key])}}" class="img-responsive btn-product-image" style="cursor: pointer;">
