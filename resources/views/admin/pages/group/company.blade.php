    ...
    <div class="content">
        <div class="col-sm-12 page-heading">
            ...
            <div class="col-sm-6">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Sister Companies</li>
                </ul>
            </div><!--End col-md-6-->
        </div>
        <div class="spacer-15"></div>
        <div class="widget">
            <form class="widget-content ajax-form" action="{{route('admin.group.company')}}" method="post" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class="img-block">
        ...
        <div class="widget">
            <div class="widget-content">
                <form method="post" action="{{route('admin.group.company.delete')}}" class="ajax-form">
                    {!! csrf_field() !!}
                    <div class="col-sm-12">
                    ...
                    <div class="table-responsive">
                        @include('admin.pages.group.templates.table2')
                    </div>
                </form>
            </div>
        </div>
