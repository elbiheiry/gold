    ...
    <div class="content ">
        ...
        <div class="widget">
            ...
            <div class="widget-content">
                <form class="ajax-form" action="{{route('admin.products.image.add' ,['id' => $product->id])}}" method="post" enctype="multipart/form-data">
        ...
        <div class="widget">
            <div class="widget-title">
                {{$product->name}}'s images edit
            </div>
            <div class="widget-content">
                <div class="spacer-15"></div>
                <div class="table-responsive">
                    @include('admin.pages.products.templates.table_img')
                </div>
            </div>
        </div>
    </div>
