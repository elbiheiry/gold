<div class="modal-dialog" role="document">
    <div class="modal-content text-center">
        ...
        <form class="edit-form" action="{{route('admin.pages.edit',['id' => $page->id])}}" method="post" enctype="multipart/form-data">
            <div class="modal-body">
                ...
                <div class="col-md-4">
                    <div class="img-block">
                        <img src="{{asset('storage/uploads/pages/'.$page->image)}}" class="img-responsive btn-product-image" style="cursor: pointer;">
